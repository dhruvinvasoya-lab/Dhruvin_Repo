...
public class tdpjson {
	...
	public void tdpjson() {
		tg.openDevice();
		tg.wait(2);
		JSONObject var_Data = tg.getJsonData("https://qainofc2.testgrid.io/s/csv-to-json/20260902/S4WoOX.json");
		tg_int var_count = 0;
		...
		tg.type("ele_FormfullName", var_fname, false);
		tg.wait(2);
		...
		tg.type("ele_Formfieldemail", var_email, false);
		tg.wait(1);
