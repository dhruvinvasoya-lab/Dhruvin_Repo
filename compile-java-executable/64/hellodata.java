...
public class hellodata {
    ...
    public static String var_ra_TestOne = "Testjfejoifjijfjsaojfiosjfiojsaiofjiosajfiosjiofjsaiojfiosajfiojsaofjsaiojfiojsaiodjasiojdiosjdioajsiodjasodjsajdoijsaidjasiojdioasjd";

    public static String var_neval = "adsasdfasdfa";

    public static String var_urbundle = "com.app.urunner";
